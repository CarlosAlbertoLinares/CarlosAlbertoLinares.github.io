...
namespace ejercicio_7_suma_resta_m_d_de_2_numeros
{
    class Program
    {
        ...
        {
            Console.WriteLine("**Este programa realiza la función de una calculadora de enteros simple** \n");
            Console.WriteLine("Favor de ingresar el primer número:");
            int x = Int32.Parse(Console.ReadLine());
            Console.WriteLine("Favor de ingresar el segundo número: ");
